...
export default function ActivityBar({ activeSection, onSectionChange, panelVisibility, onTogglePanel, onSettingsClick }: ActivityBarProps) {
  ...
  return (
    <div className="helm-activity-bar">
      <div className="helm-ab-brand">
        <div
          className="helm-ab-brand-icon"
      ...
      <div className="helm-ab-top">
        <button
          className={`helm-ab-btn${activeSection === "chat" ? " active" : ""}`}
        ...
        <button
          className={`helm-ab-btn${activeSection === "tasks" ? " active" : ""}`}
      ...
      <div className="helm-ab-bottom">
        <button
          className={`helm-ab-btn${panelVisibility.editor ? " active" : ""}`}
        ...
        <button
          className={`helm-ab-btn${panelVisibility.explorer ? " active" : ""}`}
