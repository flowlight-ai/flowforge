    ...
    <div className="flex flex-col h-full bg-[var(--bg-elevated)]">
      ...
      <div className="px-3 py-2 border-b border-[var(--border)] flex items-center gap-2 flex-shrink-0">
        ...
        <button
          ...
          className="text-[var(--muted)] hover:text-[var(--text)] disabled:opacity-30 p-1 rounded hover:bg-[var(--bg-hover)] transition-colors"
          title="后退"
        >
        ...
        <div className="flex-1 relative">
          <input
            ...
            className="w-full bg-[var(--bg-elevated)] border border-[var(--border)] rounded-lg px-3 py-1 text-xs text-[var(--text)] font-mono focus:outline-none focus:border-[var(--cafe-accent)]"
            placeholder="输入 URL..."
          />
          {isLoading && (
        ...
        {/* Viewport selector */}
        <div className="flex gap-0.5 bg-[var(--bg-hover)] rounded-lg p-0.5">
      ...
      {/* Preview area */}
      <div className="flex-1 flex items-start justify-center overflow-auto bg-[var(--bg-elevated)] p-2 min-h-0">
        <div
          style={{
        ...
        >
          ...
          />
          {pickerMode && (
            <div className="absolute inset-0 border-2 border-[var(--cafe-accent)] rounded-lg pointer-events-none" style={{ boxShadow: "0 0 0 2000px rgba(99, 102, 241, 0.05)" }}>
              <div className="absolute top-2 left-2 bg-[var(--cafe-accent)] text-[var(--cafe-accent-foreground)] text-[10px] px-2 py-0.5 rounded font-medium">
                元素选择模式
              </div>
            </div>
          )}
      ...
      {selectedElement && (
        <div className="px-3 py-2 border-t border-[var(--border)] bg-[var(--bg-elevated)] flex items-center gap-3 flex-shrink-0">
          <span className="text-[10px] text-[var(--muted)]">选中:</span>
          <code className="text-[11px] text-[var(--cafe-accent)] font-mono flex-1 truncate">{selectedElement.selector}</code>
