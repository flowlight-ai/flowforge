...
FlowForge 是为智能体提供持久身份、自进化能力和治理框架的**驾驭层（Harness Layer）**。它不替代你的智能体——而是**雇佣**它们作为能力扩展，培养成职业**可进化智能体（Forgekin）**：有名字、有记忆、有成长轨迹、有责任。现有智能体的每一项能力，FlowForge 都继承——外加六项核心能力。
