...
FlowForge 是为智能体提供持久身份、自进化能力和治理框架的**驾驭层（Harness Layer）**。它不替代你的智能体——而是**雇佣**它们作为能力扩展，培养成职业**可进化智能体（Forgekin）**：有名字、有记忆、有成长轨迹、有责任。现有智能体的每一项能力，FlowForge 都继承——外加只有 FlowForge 才有的六项。

| 能力 | Claude Code | OpenCode | Codex | WorkBuddy | Trae | Qoder | FlowForge |
|------|:-----------:|:--------:|:-----:|:---------:|:----:|:-----:|:---------:|
| 项目上下文 | ✅ `CLAUDE.md` | ✅ | ✅ `AGENTS.md` | ✅ | ✅ | ✅ Repo Wiki | ✅ |
| 深度代码库理解 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| 多智能体协作 | ✅ subagents | ✅ sub-agent | — | ✅ 专家 | — | ✅ 专家团队 | ✅ MindCouncil |
...
| CLI 支持 | ✅ | ✅ | ✅ | — | ✅ | ✅ | ✅ |
| MCP 协议 | ✅ | ✅ | ✅ | ✅ | — | ✅ | ✅ |
| 多模型支持 | — | ✅ | — | ✅ | ✅ DeepSeek | ✅ Claude/Gemini/GPT | ✅ |
| 自主执行 | ✅ checkpoints | ✅ | ✅ 云端沙箱 | ✅ | ✅ | ✅ Quest Mode | ✅ |
| 网页搜索与多模态 | — | ✅ WebSearch | ✅ 截图 | ✅ | ✅ 图→代码 | — | ✅ |
| **智能体级持久身份** | — | — | — | — | — | — | ✅ Soul Imprint |
| **自进化闭环** | — | — | — | — | — | — | ✅ 自主进化文档/代码/测试 |
| **跨厂商独立审查** | — | — | — | — | — | — | ✅ 结构强制 |
| **经验蒸馏** | — | — | — | — | — | — | ✅ SpiritForge → MindCodex |
| **渐进自主（6 级）** | — | — | — | — | — | — | ✅ 觉醒阶 |
| **多形态** | — | — | — | — | — | — | ✅ 5 种可进化形态 |
