...
async def verify_forge_all() -> dict:
    ...
    for fid in BUILTIN_FORGEKINS:
        ...
        try:
            ...
            print(f"     魂印哈希: {desc['imprint_hash'][:16]}...")
...
async def main() -> None:
    ...
    print("  2. 锻造灵智体: POST /api/v1/forgemind/forge/xianxian")
    print("  3. webchat: POST /api/v1/forgemind/webchat/xianxian")
    print("  4. IM 灵议: POST /api/v1/forgemind/council")
    print("  5. 自进化: POST /api/v1/forgemind/evolve/xianxian")
