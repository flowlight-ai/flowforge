...
- id: delegation
  ...
  config:
    - id: workflow-worker-thread
      name: '@flowforge/workflow-worker-thread'
      config:
        provider: spawn
    - id: tool-workflow
      name: '@flowforge/tool-workflow'
```
