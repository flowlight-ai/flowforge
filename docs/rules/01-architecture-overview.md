...
> **来源**：原 `hiclaw/rules.md` 第一部分
> **关联**：[doc:rules/00-v7-supplement.md]（v7.0 增补规范） | [doc:rules/02-core-architecture-principles.md]（核心架构原则）
...
> **本文件来源**：原 `hiclaw/rules.md` 第一部分 9 大项目架构总览
