...
| 3 | P1/P2 遗漏项收尾（A5-A7、A11、A13、A15-A16、A18-A19、A21-A23、A25-A28、A30-A31、B2、B6、B8-B9、B11、B13-B17、B19-B21、A35） | 🟦（**EP4-P12 收尾批次进行中** 2026-09-10：可立即实施项全量落包并提交 PR #171（新 21 包，tsc+oxlint+377 vitest 全绿，见 review_code §4。**diff 类已清点**：B8 缺 `skill-meta/manage/query`+`drift-detector/resolver`+`sync-all`（flowforge 0 命中，待补 forgekin/governance），B9 utils 多数已覆盖（F212/context-assembly/rest-controllers）、剩余纯工具待逐文件归位，B11 mcp 同步核心已并入 capabilities（仅 drift-detector/resolver 待核对）。需裁决项（A11/A13/B2/B19/A35）与 B8/B9 剩余归位待 operator 指令或门槛） |
