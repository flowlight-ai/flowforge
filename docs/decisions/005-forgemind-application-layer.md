...
FlowForge 当前架构缺少应用层——核心框架层（flowforge/）只提供基础能力，但缺少"用 FlowForge 自身能力实践万物灵智体愿景"的应用层。
...
> forgemind 将是我们 flowforge 的养灵的所有代码存放的地方（这个里边会养很多公共的灵智体，最终可以进化为物理世界中各种万事万物）
...
- `register_council_channels` — 注册灵议通道
...
- 万物灵智体愿景有明确落地位置
- FlowForge 自我演进有练兵场（forgemind 养通用灵智体）
- 通用灵智体与垂直业务灵智体清晰分离
...
- 需要新增万物灵智体形态分类机制（5 种形态 + 进化）
- 物理传感器接入需要硬件支持（Phase 6+）

### 风险

- forgemind 可能与 *Forge 垂直业务层边界模糊（缓解：明确 forgemind 只养通用灵智体）
...
### 方案 A: 把万物灵智体放到独立项目（如 forgekin/）

- 优点：FlowForge 核心保持纯粹
- 缺点：forgemind 失去 FlowForge 自我演进能力的滋养
- 未选择原因：operator 明确指示 forgemind 是 FlowForge 的应用层

### 方案 B: 把万物灵智体分散到 *Forge

- 优点：复用现有 *Forge 框架
- 缺点：通用灵智体（猫/桌椅）与垂直业务灵智体混淆
- 未选择原因：违反 operator 第 6 条指示

### 方案 C: 不新增 forgemind，万物灵智体直接在 flowforge/ 根目录
