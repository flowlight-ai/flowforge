...
| **魂忆** | EchoStore | 灵智体经验记忆 | 代码 |
| **魂印** | Soul Imprint | 灵智体身份标识 | 代码 |
| **灵锻** | SpiritForge | 经验蒸馏到灵典 | 代码 |
| **锻典** | Mind Codex | 蒸馏经验知识库 | 代码 |
| **灵议** | Mind Council | 多灵智体议事 | 代码 |
| **进化阶** | Evolution Stage | E1-E6 觉醒阶 | forgemind |
...
但对外文档（如 README、营销材料）优先使用"灵智"主名，避免"魂"字。
...
| 文件 | 替换规则 |
|------|---------|
| `flowforge/docs/spec.md` | 炉灵 → 灵智体 / E6 灵匠 → 灵智 |
| `flowforge/docs/arch.md` | 炉灵 → 灵智体 / 养灵 → 育灵 |
| `flowforge/docs/design.md` | 炉灵 → 灵智体 / M18/M19/M20 → ForgeMindEngine |
| `flowforge/docs/face/*.md` | 炉灵 → 灵智体 |
