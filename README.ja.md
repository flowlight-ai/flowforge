...
FlowForge は、エージェントに永続的アイデンティティ、自己進化能力、ガバナンス・フレームワークを提供する**ハーネス・レイヤー**だ。既存のエージェントを置き換えるのではなく——**雇用**して能力拡張とし、キャリアを持つ**進化可能エージェント（Forgekin）**へと育てる：名前を持ち、記憶を持ち、成長軌跡を持ち、責任を負うエージェントだ。既存エージェントのあらゆる能力を FlowForge は継承する——さらに FlowForge だけが持つ 6 つの能力が加わる。

| 能力 | Claude Code | OpenCode | Codex | WorkBuddy | Trae | Qoder | FlowForge |
|------|:-----------:|:--------:|:-----:|:---------:|:----:|:-----:|:---------:|
| プロジェクト文脈 | ✅ `CLAUDE.md` | ✅ | ✅ `AGENTS.md` | ✅ | ✅ | ✅ Repo Wiki | ✅ |
| コードベース深層理解 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| マルチエージェント協調 | ✅ subagents | ✅ sub-agent | — | ✅ エキスパート | — | ✅ 専門チーム | ✅ MindCouncil |
...
| CLI サポート | ✅ | ✅ | ✅ | — | ✅ | ✅ | ✅ |
| MCP プロトコル | ✅ | ✅ | ✅ | ✅ | — | ✅ | ✅ |
| マルチモデル対応 | — | ✅ | — | ✅ | ✅ DeepSeek | ✅ Claude/Gemini/GPT | ✅ |
| 自律実行 | ✅ checkpoints | ✅ | ✅ クラウドサンドボックス | ✅ | ✅ | ✅ Quest Mode | ✅ |
| ウェブ検索・マルチモーダル | — | ✅ WebSearch | ✅ スクリーンショット | ✅ | ✅ 画像→コード | — | ✅ |
| **エージェントレベルの永続的アイデンティティ** | — | — | — | — | — | — | ✅ Soul Imprint |
| **自己進化ループ** | — | — | — | — | — | — | ✅ 自律進化（ドキュメント/コード/テスト） |
| **クロスベンダー独立レビュー** | — | — | — | — | — | — | ✅ 構造的に強制 |
| **経験蒸留** | — | — | — | — | — | — | ✅ SpiritForge → MindCodex |
| **漸進的自律（6 段階）** | — | — | — | — | — | — | ✅ 覚醒段階 |
