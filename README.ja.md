...
FlowForge は、コーディング・エージェントに永続的アイデンティティ、自己進化能力、ガバナンス・フレームワークを提供する**ハーネス・レイヤー**だ。既存のエージェントを置き換えるのではなく——**雇用**して能力拡張とし、キャリアを持つ**進化可能エージェント（Forgekin）**へと育てる：名前を持ち、記憶を持ち、成長軌跡を持ち、責任を負うエージェントだ。
