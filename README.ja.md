...
|------|:-----------:|:--------:|:-----:|:---------:|:----:|:-----:|:---------:|
| 自律タスク実行 | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
| マルチエージェント編成 | ✅ subagents | ✅ | — | ✅ Agent Team | — | ✅ 専門チーム | ✅ MindCouncil |
| 文脈・長期記憶 | ✅ `CLAUDE.md` | ✅ | ✅ `AGENTS.md` | ✅ 多層記憶 | ✅ | ✅ Knowledge Engine | ✅ EchoStore + MindCodex |
| ツール使用・API 編成 | ✅ MCP | ✅ MCP | ✅ MCP | ✅ MCP | ✅ | ✅ MCP | ✅ MCP |
| クロスシステム統合 | ✅ IDE/Git | ✅ | ✅ IDE/Git/CI | ✅ Office/WeCom | ✅ 飛書/IDE | ✅ IDE | ✅ エージェント経由 |
| ウェブ検索・マルチモーダル | — | ✅ | ✅ | ✅ | ✅ 画像→コード | — | ✅ |
| デスクトップ・オフィス自動化 | — | — | — | ✅ Word/Excel/PPT | ✅ | ✅ QoderWork | ✅ |
| 自己反思・継続改善 | — | — | — | — | — | ✅ 意識機能 | ✅ |
