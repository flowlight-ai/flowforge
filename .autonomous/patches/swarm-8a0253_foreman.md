...
from flowforge.common.logging import get_logger
...
class ContinuousForeman:
    ...
    async def start(self) -> None:
        ...
        if self._task is not None and not self._task.done():
            self._logger.warning("Foreman 已在运
```