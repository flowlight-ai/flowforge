...
class ForemanConfig:
    """Foreman 调度器配置参数"""
    loop_interval_seconds: float = field(default=8.0)
...
class ContinuousForeman:
    ...
    def __init__(
        ...
        *,
        ...
        self._magic_words_callback: Optional[Callable[[], Awaitable[Optional[str]]]] = None
