...
class ClaudeCodeAdapter(ExternalAgentAdapter):
    ...
    详见 [doc:review/review/review.md#第九章§9.2] EX-001~EX-010
    """
    ...
    def __init__(self, manifest: AgentProviderManifest):
    ...
    async def invoke(
        ...
        半实现状态：演示 NDJSON + stderr 解析能力，厂商参考实现替换 ``# TODO: 厂商实现`` 标记的 subprocess 调用部分即可。
        ...
        5. 封装为 ExternalAgentResult（success 仅看 returncode==0，"stderr 也算活着"教训）
