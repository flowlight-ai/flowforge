...
> 
> 文件路径：flowforge/external_agent/adapter/claude_code.py
> 
> 
> 
...
class ClaudeCodeAdapter(ExternalAgentAdapter):
    ...
    async def invoke(
        ...
        # 真实 Claude CLI 进程调用，移除 mock 演示代码
