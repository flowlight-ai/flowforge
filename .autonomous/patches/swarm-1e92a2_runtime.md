...
- **task_id**: swarm-1e92a2056dd3
- **title**: 修复代码 TODO: flowforge\evolution\runtime.py
- **agent**: forgemind:sherlock
- **model**: Doubao-Seed2.0
- **generated_at**: 2026-08-01T00:17:25.951450+00:00
...
from flowforge.config.trae_bridge import TraeBridgeConfig
...
from flowforge.approval.models import ApprovalRequest
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            approval_mode: 审批模式（"auto"/"manual"/"
```