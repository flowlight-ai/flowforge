...
# 文件路径：src/flowforge/tools/state_query.py
...
class StateQueryTool:
    ...
    def _get_web_search(self):
        ...
        for mod_path in mod_candidates:
            module_name, class_name = mod_path.rsplit(".", 1)
            try:
        ...
        try:
            ...
            for entry_key, entry_data in raw_data.items():
                if not isinstance(entry_data, dict):
                    continue
                # Scope filtering: skip entries beyond 
```