...
class DurableState(BaseModel):
    state_id: str = Field(..., description="记录唯一 ID")
    ...
    @classmethod
    def new_empty(cls, key: str, value: Any, writer: str) -> "DurableState":
        """便捷构造全新状态记录，自动生成state_id"""
