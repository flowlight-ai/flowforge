...
```
# 文件路径: flowforge/tools/state_query/state_query_tool.py
...
class StateQueryTool:
    """
    通用状态查询工具基类
    支持内存状态优先查询、超出范围降级全网搜索、按scope合并状态数据
    """

    # 子类必须覆盖：状态key模板、范围字段、合并字段配置
