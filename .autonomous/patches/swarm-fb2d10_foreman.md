...
FlowForge SelfDevRuntime 常驻调度核心，5 Agent Sweet Spot 持续闭环调度
Magic Words 人工干预、任务分发、超时重分配、紧急任务队列、Swarm 协调
"""
...
class ContinuousForeman:
    ...
    def __init__(
        ...
        *,
        ...
        self._logger.info(
            f"ContinuousForeman 初始化: interval={self._config.loop_interval_se
```