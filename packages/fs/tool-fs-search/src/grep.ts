 ...
 *
 * @module @flowforge/tool-fs-search/grep
 */

import type { Context } from '@flowforge/cordis'
import { defineTool } from '@flowforge/tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@flowforge/tools'
import type { RetainedItems } from '@flowforge/output-retention'
import type { SpillRef } from '@flowforge/spill'
