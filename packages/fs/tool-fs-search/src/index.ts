 ...
 * ({@link module:@flowforge/tool-fs-search/glob} /
 * {@link module:@flowforge/tool-fs-search/grep}), result parsing,
 ...
 *
 * @module @flowforge/tool-fs-search
 */
...
export interface Config {
   ...
   * `@flowforge/tool-call-timeout-policy` through `exec.signal`.
   */
  timeoutMs?: number
}
