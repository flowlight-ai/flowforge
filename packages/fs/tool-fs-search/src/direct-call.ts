/** Shared top-level-call post-policy selection for search result spill. @module flowforge-tool-fs-search/direct-call */

import type { Context } from '@flowforge/cordis'
import type { JsonValue, PostToolDecision, ToolDefinition, ToolExecution, ToolExecutionResult } from '@flowforge/tools'
