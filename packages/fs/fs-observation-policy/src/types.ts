 ...
 * re-used from `@flowforge/fs`; this package owns only the observed-state
 * owner structure on top of it.
 *
 * @module @flowforge/fs-observation-policy/types
 */

/**
 * Minimal structural view of a tool execution the policy plugin needs to derive
 * an observed-state owner. `@flowforge/tools`' `ToolExecution` contains
 ...
 * `FsObservationActor` without importing `flowforge-tools`, `flowforge-agent`, or `flowforge-session`.
 *
