/**
 * Package-owned invariant companion for `@flowforge/tool-str-replace-editor`.
 * @module @flowforge/tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@flowforge/tool-str-replace-editor'
