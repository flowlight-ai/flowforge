/**
 * Real-load-path guard for @flowforge/mcp-client. `mcp-client` is a
...
import * as mcpClient from '@flowforge/mcp-client'

describe('flowforge-mcp-client real-load-path guard', () => {
