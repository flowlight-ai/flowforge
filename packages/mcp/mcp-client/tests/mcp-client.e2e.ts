/**
 * End-to-end tests for flowforge-mcp-client. Exercises the REAL MCP protocol against:
...
import { apply } from '@flowforge/mcp-client/src/index.ts'
import { publicToolName } from '@flowforge/mcp-client/src/tools.ts'
import type { Config } from '@flowforge/mcp-client'
