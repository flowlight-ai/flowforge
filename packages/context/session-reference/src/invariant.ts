/**
 * Package-owned invariant companion for `@flowforge/session-reference`.
 * @module @flowforge/session-reference/invariant
 */
...
const PACKAGE_NAME = '@flowforge/session-reference'
