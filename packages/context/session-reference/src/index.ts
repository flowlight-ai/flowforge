 ...
 *
 * @module @flowforge/session-reference
 */
...
import type { ContentBlock, UserMessage } from '@flowforge/llm'
import type { SessionId } from '@flowforge/session'
import type { SessionSurfaceSnapshot, SessionTitleObservationResult } from '@flowforge/session-query'
import {
