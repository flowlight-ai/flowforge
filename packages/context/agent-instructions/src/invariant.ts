/**
 * Package-owned invariant companion for `@flowforge/agent-instructions`.
 * @module @flowforge/agent-instructions/invariant
 */
...
const PACKAGE_NAME = '@flowforge/agent-instructions'
