 ...
 *
 * @module @flowforge/agent-instructions/render
 */
...
/**
 * File name of the single user-global instruction file under `$FF_HOME`.
 * Discovery (`$FF_HOME/<name>`) and reconciliation (the user-global scope key's
...
export function scopeForDisplayPath(displayPath: string): string {
  if (displayPath === '~/.flowforge/AGENTS.md' || displayPath === '$FF_HOME/AGENTS.md') return USER_GLOBAL_DIRECTORY
