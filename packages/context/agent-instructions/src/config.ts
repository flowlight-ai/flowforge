 ...
 *
 * @module @flowforge/agent-instructions/config
 */
...
export interface Config {
  /** Harness home containing the fixed user-global `AGENTS.md`; defaults to `$FF_HOME` or `~/.flowforge`. */
...
export function resolveDiscoveryConfig(
  config: Pick<Config, 'flowforgeHome' | 'projectRootMarkers' | 'instructionFileCandidates' | 'localInstructionFileCandidates'>,
): ResolvedDiscoveryConfig {
  return {
    flowforgeHome: resolveFlowforgeHome(config.flowforgeHome),
