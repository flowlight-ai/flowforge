/**
 * Package-owned invariant companion for `@flowforge/jobs-local`.
 * @module @flowforge/jobs-local/invariant
 */
...
const PACKAGE_NAME = '@flowforge/jobs-local'
...
/**
 * No runtime invariant: `@flowforge/jobs/invariant` owns per-snapshot identity, status,
