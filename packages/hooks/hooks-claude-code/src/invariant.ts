/**
 * Package-owned invariant companion for `@flowforge/hooks-claude-code`.
 * @module @flowforge/hooks-claude-code/invariant
 */
...
const PACKAGE_NAME = '@flowforge/hooks-claude-code'
