 ...
 * mapping; shared execution and parsing live in `flowforge-hook-protocol`.
 ...
 * @module @flowforge/hooks-claude-code
 */
...
import type { UserMessage } from '@flowforge/session'
import type {} from '@flowforge/session-persistence'
import type { PostToolDecision, PreToolDecision, ToolExecution, ToolExecutionResult } from '@flowforge/tools'
import {
  appendHookInvoked,
  appendHookResult,
  createDetachedRuns,
