/**
 * Package-owned invariant companion for `@flowforge/credentials-local`.
 * @module @flowforge/credentials-local/invariant
 */
...
const PACKAGE_NAME = '@flowforge/credentials-local'
...
/**
 * No runtime invariant: the Service Definition companion (`flowforge-credentials/invariant`) owns the
