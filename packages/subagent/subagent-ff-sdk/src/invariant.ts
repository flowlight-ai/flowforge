/**
 * Package-owned invariant companion for `@flowforge/subagent-ff-sdk`.
 * @module @flowforge/subagent-ff-sdk/invariant
 */
...
const PACKAGE_NAME = '@flowforge/subagent-ff-sdk'

/** Cordis companion plugin name. */
export const name = 'subagent-ff-sdk-invariant'
