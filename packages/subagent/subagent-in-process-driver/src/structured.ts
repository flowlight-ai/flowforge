 ...
 * @module @flowforge/subagent-in-process-driver/structured
 */

import type { Context } from '@flowforge/cordis'
import type { ToolSchema } from '@flowforge/llm'
import type { ToolExecution, ToolRunContext } from '@flowforge/tools'
import { ToolArgsError, validateJsonSchemaValue, type ObjectJsonSchema } from '@flowforge/tools'
 ...
 *   `assertObjectJsonSchema` in flowforge-tools).
