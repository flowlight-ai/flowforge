/**
 * Package-owned invariant companion for `@flowforge/tool-subagent-report`.
 * @module @flowforge/tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@flowforge/tool-subagent-report'
