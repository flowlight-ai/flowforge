/**
 * Package-owned invariant companion for `@flowforge/tool-subagent-control`.
 * @module @flowforge/tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@flowforge/tool-subagent-control'
