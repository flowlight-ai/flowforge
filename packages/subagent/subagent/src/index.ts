 ...
 * (`@flowforge/subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@flowforge/tool-subagent`) are separate packages.
 *
...
import { assertObjectJsonSchema } from '@flowforge/tools'
import type { ContentBlock, MessageId } from '@flowforge/llm'
