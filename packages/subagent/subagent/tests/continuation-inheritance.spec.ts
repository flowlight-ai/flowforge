...
import SandboxPolicyService, { effectiveSandboxMode, setSandboxMode } from '@flowforge/sandbox-policy'
...
import ApprovalService, { effectiveApprovalPolicy } from '@flowforge/user-approval'
...
async function setup(script: Script) {
  ...
  const root = mkdtempSync(join(tmpdir(), 'flowforge-continuation-inherit-'))
  roots.push(root)
