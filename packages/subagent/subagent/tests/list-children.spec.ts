...
import SessionStore, { SESSION_FORMAT_VERSION, SessionId } from '@flowforge/session'
import type { SessionEvent, SessionHeader } from '@flowforge/session'
...
import type { ProjectionDefinition } from '@flowforge/session-projection'
import SessionProjectionCache from '@flowforge/session-projection-cache'
...
import SubagentRuntime, {
  ...
  SubagentError,
} from '@flowforge/subagent'
import * as SubagentSpawn from '@flowforge/subagent-spawn-in-process'
import * as SubagentFork from '@flowforge/subagent-fork-in-process'
...
async function setup(
  ...
  const root = mkdtempSync(join(tmpdir(), 'flowforge-subagent-list-'))
  roots.push(root)
...
declare module '@flowforge/session-projection/types' {
