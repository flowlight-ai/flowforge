...
import ToolRuntime, { RUN_CODE_NAME, defineContentToolFixture } from '@flowforge/tools'
import { Session, SessionId, type UserMessage } from '@flowforge/session'
import AgentRegistry, { agentEvents, type Agent } from '@flowforge/agent'
...
import { CodeRuntime, type CodeRunRequest, type CodeRunResult } from '@flowforge/code-runtime'
...
/**
 * Drives the REAL plugin: mounts `flowforge-plan-mode` beside real `SystemPrompt` and
