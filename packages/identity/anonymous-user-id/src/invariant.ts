/**
 * Package-owned invariant companion for `@flowforge/anonymous-user-id`.
 * @module @flowforge/anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@flowforge/anonymous-user-id'
