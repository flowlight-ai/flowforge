 ...
 *
 * @module flowforge-permission-presets
 */

import { Context, Service } from '@flowforge/cordis'
import z from '@flowforge/schemastery'
import { z as zod } from 'zod'
import type { Session, SessionEvent } from '@flowforge/session'
import type { SandboxMode } from '@flowforge/sandbox'
import { SANDBOX_MODES, effectiveSandboxMode, setSandboxMode } from '@flowforge/sandbox-policy'
...
import type {} from '@flowforge/shell'
import type { ApprovalPolicy } from '@flowforge/user-approval'
import { APPROVAL_POLICIES, effectiveApprovalPolicy, setApprovalPolicy } from '@flowforge/user-approval'
import { installSettingsSection, settingsNamespace } from '@flowforge/settings'
...
declare module '@flowforge/session/types' {
