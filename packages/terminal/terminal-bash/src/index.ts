 ...
 * @module @flowforge/terminal-bash
 */

import { Context } from '@flowforge/cordis'
import type { Agent } from '@flowforge/agent'
import type { Session, SessionEvent } from '@flowforge/session'
import { TerminalBackendCleanupError } from '@flowforge/terminal'
import type { TerminalBackend, TerminalBackendSpawnSpec } from '@flowforge/terminal'
import type { SubprocessTerminalHandle, SubprocessTerminalSpawnSpec } from '@flowforge/subprocess'
import type { SandboxExecutionPolicy } from '@flowforge/sandbox'
import { effectiveSandboxMode } from '@flowforge/sandbox-policy'
...
function childEnvironment(spec: TerminalBackendSpawnSpec): Record<string, string> {
  ...
  return {
    ...
    FF_SHELL: '1',
    FF_SESSION_ID: spec.owner.id,
    FF_PTY_SESSION_ID: spec.sessionId,
  }
}
