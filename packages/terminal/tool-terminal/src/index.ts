 ...
 * @module @flowforge/tool-terminal
 */
...
import { TerminalSessionId } from '@flowforge/terminal'
import type { TerminalSendResult, TerminalSessionId as TerminalSessionIdType, TerminalSignal } from '@flowforge/terminal'
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: SendArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) throw new Error('background terminal sends require @flowforge/jobs and @flowforge/tool-jobs')
