 ...
 * @module @flowforge/session-title-llm
 */

import type { Context } from '@flowforge/cordis'
import z from '@flowforge/schemastery'
import { createUserMessage, BlockAssembler, deepFreeze } from '@flowforge/llm'
import type { FinishReason, GenerateOptions, Message } from '@flowforge/llm'
import { deadline, MAX_TIMER_DELAY_MS } from '@flowforge/timeout'
import {
  normalizeSessionTitle,
  SessionTitleProviderId,
} from '@flowforge/session-title'
import type {
...
export async function generateSessionTitleWithLlm(
  ...
  const messages: Message[] = [createUserMessage({
    ...
    source: { kind: 'plugin', plugin: 'flowforge-session-title-llm' },
  })]
