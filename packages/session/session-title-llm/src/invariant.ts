/**
 * Package-owned invariant companion for `@flowforge/session-title-llm`.
 * @module @flowforge/session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@flowforge/session-title-llm'
