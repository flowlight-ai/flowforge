/**
 * Package-owned invariant companion for `@flowforge/session-persistence-jsonl`.
 * @module @flowforge/session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@flowforge/session-persistence-jsonl'
