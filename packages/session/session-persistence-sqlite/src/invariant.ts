/**
 * Package-owned invariant companion for `@flowforge/session-persistence-sqlite`.
 * @module @flowforge/session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@flowforge/session-persistence-sqlite'
