/**
 * Frozen released-v2 event dispositions. Derived from the released-v0 inventory
 * minus the discarded v1 top-level Assistant chunk/message shapes and minus the
 * removed seed markers, plus the new v2 Assistant attempt shape and the tagged
 * inherited end-seed marker. Ported from dsh `dsh-session-format-v1-to-v2`.
 */
