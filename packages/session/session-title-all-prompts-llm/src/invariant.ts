/**
 * Package-owned invariant companion for `@flowforge/session-title-all-prompts-llm`.
 * @module @flowforge/session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@flowforge/session-title-all-prompts-llm'
