/**
 * Package-owned invariant companion for `@flowforge/session-projection-cache`.
 * @module @flowforge/session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@flowforge/session-projection-cache'
