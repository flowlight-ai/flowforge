/**
 * Package-owned invariant companion for `@flowforge/session-projection`.
 * @module @flowforge/session-projection/invariant
 */
...
const PACKAGE_NAME = '@flowforge/session-projection'
