/**
 * Package-owned invariant companion for `@flowforge/session-title-first-prompt-llm`.
 * @module @flowforge/session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@flowforge/session-title-first-prompt-llm'
