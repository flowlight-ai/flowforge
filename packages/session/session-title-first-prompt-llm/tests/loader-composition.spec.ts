...
import LlmRuntime, { createUserMessage, LlmAdapter  } from '@flowforge/llm'
import type { GenerateOptions, StreamChunk } from '@flowforge/llm'
import SessionStore, { SessionId } from '@flowforge/session'
import SessionTitleService from '@flowforge/session-title'
import * as providerPlugin from '@flowforge/session-title-first-prompt-llm'
...
async function loadComposition(): Promise<Context> {
  ...
  await writeFile(configPath, [
    ...
    "- name: '@flowforge/session-title'",
    '  config:',
    '    fallbackMaxWords: 5',
    '    fallbackMaxBytes: 40',
    '    maxTitleBytes: 80',
    "- name: '@flowforge/session-title-first-prompt-llm'",
    '  config:',
    '    targetWords: 5',
  ...
  const modules = new Map<string, unknown>([
    ...
    ['@flowforge/session-title', SessionTitleService],
    ['@flowforge/session-title-first-prompt-llm', providerPlugin],
  ])
