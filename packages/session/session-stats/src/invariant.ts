/**
 * Package-owned invariant companion for `@flowforge/session-stats`.
 * @module @flowforge/session-stats/invariant
 */
...
const PACKAGE_NAME = '@flowforge/session-stats'
 ...
 * ids) are owned and runtime-checked by flowforge-agent-loop and the session
 * surface, not here.
 */
