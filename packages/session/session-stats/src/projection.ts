 ...
 * (`deriveStats` in flowforge-client-ui-conversation, that fold's whole-window
 ...
 *
 * @module @flowforge/session-stats/projection
 */

import { z } from 'zod'
import { isTokenDelta } from '@flowforge/llm/message'
