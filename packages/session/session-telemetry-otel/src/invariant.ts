/**
 * Package-owned invariant companion for `@flowforge/session-telemetry-otel`.
 * @module @flowforge/session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@flowforge/session-telemetry-otel'
