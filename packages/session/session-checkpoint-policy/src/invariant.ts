/**
 * Package-owned invariant companion for `@flowforge/session-checkpoint-policy`.
 * @module @flowforge/session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@flowforge/session-checkpoint-policy'
