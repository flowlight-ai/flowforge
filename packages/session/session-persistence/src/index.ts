 ...
 * @module @flowforge/session-persistence
 */

import { Context, Service } from '@flowforge/cordis'
import { SessionPreparation } from '@flowforge/session'
import type { SessionEvent, SessionId, SessionHeader } from '@flowforge/session'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@flowforge/session'
