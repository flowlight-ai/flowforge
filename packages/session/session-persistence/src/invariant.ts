/**
 * Package-owned invariant companion for `@flowforge/session-persistence`.
 * @module @flowforge/session-persistence/invariant
 */
...
const PACKAGE_NAME = '@flowforge/session-persistence'
