/**
 * Package-owned invariant companion for `@flowforge/session-telemetry`.
 * @module @flowforge/session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@flowforge/session-telemetry'
