/**
 * @flowforge/cmdline — the command line a flowforge launcher hands to the app
 * it boots.
 *
 ...
 * verbatim and in argv order. `flowforge --profile tui --resume abc` yields
 * `['--resume', 'abc']`.
 */
