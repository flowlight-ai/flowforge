/**
 * Package-owned invariant companion for `@flowforge/command-feedback`.
 * @module @flowforge/command-feedback/invariant
 */
...
const PACKAGE_NAME = '@flowforge/command-feedback'
