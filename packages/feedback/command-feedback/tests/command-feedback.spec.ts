...
import SessionStore, { foldSurface, Session, SessionId } from '@flowforge/session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@flowforge/session-telemetry'
...
vi.mock('@flowforge/anonymous-user-id', () => ({
...
describe('@flowforge/command-feedback registration', () => {
