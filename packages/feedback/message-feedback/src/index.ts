 ...
 * @module @flowforge/message-feedback
 */

import { Buffer } from 'node:buffer'
import { randomUUID } from 'node:crypto'
import { Context, Service } from '@flowforge/cordis'
import s from '@flowforge/schemastery'
import { deriveEventMessage, isAppendSurfaceEvent } from '@flowforge/session/surface'
import type { SessionHeader, SessionId } from '@flowforge/session/types'
import type { SessionInspection } from '@flowforge/session-persistence'
import type { KvTable } from '@flowforge/storage-domain'
import { TypertRemoteService, Remote } from '@flowforge/typert-protocol'
