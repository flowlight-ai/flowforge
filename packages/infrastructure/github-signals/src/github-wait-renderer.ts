/**
 * @flowforge/infrastructure-github-signals — GitHub wait outcome renderer
 *
 * Self-contained port of the clowder-ai `domains/github-signals/github-wait-renderer.ts`:
 * review-loop-brake classification plus the compact `renderGitHubWaitOutcome` message.
 */

import type { WaitOutcomeV1 } from './contract/github-wait.ts'
