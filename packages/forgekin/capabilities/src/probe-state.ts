/**
 * Probe State — F146-C AC-C3/C4/C6：MCP 探测结果 → 持久化 probe state。
 *
 * 移植自 clowder-ai `config/capabilities/probe-state.ts`。
 */

import type { ProbeState } from '@flowforge/cats-shared';
