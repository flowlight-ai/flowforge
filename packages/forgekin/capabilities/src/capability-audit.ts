/**
 * Capability Audit — `.cat-cafe/audit.jsonl` 追加式审计日志。
 *
 * 移植自 clowder-ai `config/capabilities/capability-audit.ts`。
 */

import { appendFile, mkdir, readFile } from 'node:fs/promises';
import { join } from 'node:path';
import type { CapabilityAuditEntry } from '@flowforge/cats-shared';
