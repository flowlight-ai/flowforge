/**
 * Shared rendering helpers for the shell tools (`flowforge-tool-bash`,
 * `flowforge-tool-pwsh`): the exit-status marker contract the tools' renderers
 * emit and the presentation layer parses back.
 * @module @flowforge/shell/render
 */
