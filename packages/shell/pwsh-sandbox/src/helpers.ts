 ...
 * mirror of `@flowforge/bash-sandbox/src/helpers.ts` (the pwsh twin of
 * the bash consumer shares the identical classification dialect).
 *
 * @module @flowforge/pwsh-sandbox/helpers
 */

/* jscpd:ignore-start */
import { accessSync, constants, statSync } from 'node:fs'
import type { ShellRunResult } from '@flowforge/shell'
import type { RunnerFailureRule } from '@flowforge/sandbox'
