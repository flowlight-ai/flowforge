/**
 * Package-owned invariant companion for `@flowforge/tool-bash-persistent`.
 * @module @flowforge/tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@flowforge/tool-bash-persistent'
