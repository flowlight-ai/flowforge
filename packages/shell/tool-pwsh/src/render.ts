 ...
 * `flowforge-tool-bash`'s renderer: stdout, a marked stderr section, sandbox
 ...
 * results.
 *
 * @module @flowforge/tool-pwsh/render
 */

import type { ShellProcessRead, ShellSandboxInfo, CollectedOutput } from '@flowforge/shell'
import type { SandboxMode } from '@flowforge/sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@flowforge/sandbox'

/* jscpd:ignore-start -- deliberate twin of flowforge-tool-bash/render.ts (Agent Note). */
