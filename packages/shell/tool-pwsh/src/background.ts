 ...
 * twin of `flowforge-tool-bash`'s background adaptation.
 *
 * @module @flowforge/tool-pwsh/background
 */

import type { ShellProcess } from '@flowforge/shell'

/* jscpd:ignore-start -- deliberate twin of flowforge-tool-bash/background.ts (Agent Note). */
