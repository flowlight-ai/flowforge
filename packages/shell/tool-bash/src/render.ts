 ...
 *
 * @module @flowforge/tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@flowforge/shell'
import type { SandboxMode } from '@flowforge/sandbox'
import { escalationHintMarker, sandboxDenialMarker } from '@flowforge/sandbox'
 ...
 * rendering story, owned by `@flowforge/shell` so `flowforge-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@flowforge/shell'
