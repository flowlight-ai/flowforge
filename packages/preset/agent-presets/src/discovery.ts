 ...
 * @module @flowforge/agent-presets/discovery
 */
...
import { expandHomePath } from '@flowforge/home-paths'
 ...
 *
 * This package owns the writable root the way `flowforge-skill-filesystem` owns
 * `<flowforgeHome>/skills`. An app must assemble the SHIPPED root, whose path only
