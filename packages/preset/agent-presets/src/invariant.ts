/**
 * Package-owned invariant companion for `@flowforge/agent-presets`.
 * @module @flowforge/agent-presets/invariant
 */
...
// joins, and the `agent` field `flowforge-agent` merges into its context.
...
import { leakedServices, livePresetMounts } from '@flowforge/agent-presets'

const PACKAGE_NAME = '@flowforge/agent-presets'
