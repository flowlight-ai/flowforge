/** The native default-browser handoff adapter: scrubbed env, spawn wiring, and error mapping. */
...
describe('web-app browser opener', () => {
  it('scrubs the helper environment and reports helper spawn or exit failures', async () => {
    ...
    vi.stubEnv('FF_HOME', '/must-not-reach-browser')
    ...
    expect(options?.env).not.toHaveProperty('FF_HOME')
