/**
 * `@flowforge/web-search-exa`: registers an Exa-backed `WebSearchProvider`
 ...
 * seam's provider registry, exactly as `@flowforge/llm-deepseek`
 * registers an adapter into `ctx.llm`. The key is owned by `@flowforge/web`.
 *
 * @module @flowforge/web-search-exa
 */
...
import type {} from '@flowforge/web'
import {
  ExaSearchProvider,
