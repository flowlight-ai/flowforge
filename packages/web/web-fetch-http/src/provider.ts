 ...
 * `@flowforge/tool-web`. Requests carry no browser cookies or ambient credentials.
 *
 ...
 * @module @flowforge/web-fetch-http/provider
 */

import { WebError } from '@flowforge/web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@flowforge/web'
