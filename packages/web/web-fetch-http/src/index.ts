/**
 * `@flowforge/web-fetch-http`: registers an anonymous public HTTP(S)
 ...
 *
 * @module @flowforge/web-fetch-http
 */
...
export const DEFAULT_USER_AGENT = 'flowforge/0.0.1 (+https://gitee.com/flowlight-ai/flowforge)'
