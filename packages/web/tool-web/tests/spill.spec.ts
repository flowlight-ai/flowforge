 ...
 * (`flowforge-spill-local` backend + `flowforge-spill-policy`), exercised through
...
import LocalSpillStore from '@flowforge/spill-local'
...
beforeEach(async () => {
  ...
  spillRoot = mkdtempSync(join(tmpdir(), 'flowforge-spill-web-'))
