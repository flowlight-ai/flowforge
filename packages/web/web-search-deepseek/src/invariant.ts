/**
 * Package-owned invariant companion for `@flowforge/web-search-deepseek`.
 * @module @flowforge/web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@flowforge/web-search-deepseek'
