 ...
 * @module @flowforge/web-search-deepseek/provider
 */

import { WebError } from '@flowforge/web'
import type {
  WebSearchProvider,
  WebSearchRequest,
  WebSearchResult,
...
import type {} from '@flowforge/session'
import type {
  AnthropicError,
  AnthropicResponse,
  ContentBlock,
 ...
 * (`https://api.deepseek.com`) `@flowforge/llm-deepseek` uses, so this
...
const USER_AGENT = 'flowforge/0.0.1'
