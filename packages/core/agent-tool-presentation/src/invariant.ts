/**
 * Package-owned invariant companion for `@flowforge/agent-tool-presentation`.
 * @module @flowforge/agent-tool-presentation/invariant
 */
...
const PACKAGE_NAME = '@flowforge/agent-tool-presentation'
 ...
 * registry's to hold, and `flowforge-tools` observes it there.
 */
