 ...
 * ([`flowforge-code-runtime-worker-thread`](../../code-runtime/code-runtime-worker/README.md)).
 ...
 * @module @flowforge/agent-tool-presentation
 */

import type { Context } from '@flowforge/cordis'
import z from '@flowforge/schemastery'
import type { ToolPresentationMode } from '@flowforge/tools'
...
export function apply(ctx: Context, config: Config): void {
  ...
  // what `flowforge-agent-presets` reports as an unusable row, naming this id.
