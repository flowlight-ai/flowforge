/** Package-owned scoped-dispatch invariants. @module @flowforge/scope/invariant */

import type { Context } from '@flowforge/cordis'
import type { InvariantInstaller } from '@flowforge/invariants'
import { carrierKeyOf, isScopeCarrier } from '@flowforge/scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@flowforge/scope'
