 ...
 * turn/step boundaries remain `@flowforge/session` events.
 *
...
import type { LlmCallConfig, LlmFailure, ResolvedRetryPolicy } from '@flowforge/llm'
import type { AgentCancelCause, Session, SessionId, UserMessage } from '@flowforge/session'
export type { AgentCancelCause } from '@flowforge/session'
import type { Inbox } from './inbox.ts'
import type { InboxTarget } from './types.ts'
import type {} from '@flowforge/system-prompt'
declare module '@flowforge/system-prompt' {
...
declare module '@flowforge/cordis' {
  interface Events {
     ...
     * Scope-filtered dispatch (`@flowforge/scope`): agent-scoped listeners receive only that agent.
     * @mode emit
     */
