...
import { createScope, scopeOf } from '@flowforge/scope'
import type { Scope, ScopeKey } from '@flowforge/scope'
import SystemPrompt, { TOOL_ORDER_REST, renderContextSnapshot, renderPrompt } from '@flowforge/system-prompt'
import type { Config, PromptAssembly } from '@flowforge/system-prompt'
