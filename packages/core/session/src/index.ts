 ...
 *
 * @module @flowforge/session
 */

import { Context, Service } from '@flowforge/cordis'
import { isAbsolute } from 'node:path'
import { deepFreeze } from '@flowforge/llm'
import { scopeOf, scopeTarget } from '@flowforge/scope'
import type { Scoped } from '@flowforge/scope'
import type { Message } from '@flowforge/llm'
import { SESSION_FORMAT_VERSION, SessionId } from './types.ts'
import type { TypertLookup } from '@flowforge/typert-protocol'
...
export type { AssistantMessage, ToolResultMessage, UserMessage } from '@flowforge/llm'
...
declare module '@flowforge/cordis' {
  ...
  interface Events {
     ...
     * Scope-filtered dispatch (`@flowforge/scope`): agent-scoped listeners
     ...
     * Scope-filtered dispatch (`@flowforge/scope`) reuses the owner scope.
     ...
     * (`@flowforge/scope`) reuses the session's owner scope.
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('session', {
        parameter: 'session',
        wire: 'sessionId',
        hostTypeSymbol: '@flowforge/session#Session',
        wireTypeSymbol: '@flowforge/session/types#SessionId',
