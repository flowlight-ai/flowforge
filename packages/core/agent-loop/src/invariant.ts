 ...
 * @module @flowforge/agent-loop/invariant
 */

import type { Context } from '@flowforge/cordis'
import { isAgentLoopRequest, type GenerateOptions } from '@flowforge/llm'
import type { InvariantFailure, InvariantInstaller } from '@flowforge/invariants'
import { foldRequestHeader } from '@flowforge/session'

const PACKAGE_NAME = '@flowforge/agent-loop'
