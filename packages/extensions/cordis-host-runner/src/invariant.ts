/**
 * Package-owned invariant companion for `@flowforge/cordis-host-runner`.
 * @module @flowforge/cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@flowforge/cordis-host-runner'
