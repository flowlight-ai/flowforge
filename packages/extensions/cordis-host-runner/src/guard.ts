 ...
 * @module @flowforge/cordis-host-runner/guard
 */

import { Context } from '@flowforge/cordis'
import type { Plugin } from '@flowforge/cordis'
import { scopeOf } from '@flowforge/scope'
import { assertSupportedJsonSchema, defineTool } from '@flowforge/tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@flowforge/cordis-client-runner`, whose CTX_VERBS names this one its
