 ...
 * plugin's apply closure (pure-logic port of the dsh `inventory.ts`).
 *
 ...
 * for a fresh one.
 *
 * @module @flowforge/ui-cordis/inventory
 */

import type { HostObservable } from './observable.ts'
...
export default createCordisInventory