/**
 * Package-owned invariant companion for `@flowforge/output-retention`.
 * @module @flowforge/output-retention/invariant
 */
...
const PACKAGE_NAME = '@flowforge/output-retention'
