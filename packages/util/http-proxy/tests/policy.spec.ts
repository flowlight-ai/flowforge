...
describe('resolveProxyPolicy', () => {
  ...
  it('prefers the lowercase name, matching a consumer precedence', () => {
  ...
  it('backs both schemes with ALL_PROXY', () => {
  ...
  it('falls HTTPS back to the HTTP proxy last, so the policy and proxyForUrl agree', () => {
...
describe('bypassesProxy', () => {
  ...
  it('bypasses a bare IPv6 loopback', () => {
