/**
 * Package-owned invariant companion for `@flowforge/launch-environment`.
 * @module @flowforge/launch-environment/invariant
 */
...
const PACKAGE_NAME = '@flowforge/launch-environment'
