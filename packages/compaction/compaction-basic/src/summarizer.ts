 ...
 *
 * @module @flowforge/compaction-basic/summarizer
 */

import type { Context } from '@flowforge/cordis'
import { contentHasImage, createUserMessage, BlockAssembler, LlmError } from '@flowforge/llm'
import type {
...
export async function summarizeWithLlm(
  ...
  const messages: Message[] = [
    ...
    createUserMessage({
      ...
      source: { kind: 'plugin', plugin: 'flowforge-compaction-basic' },
    }),
  ]
