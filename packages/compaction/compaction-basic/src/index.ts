 ...
 *
 * @module @flowforge/compaction-basic
 */

import { Context } from '@flowforge/cordis'
import z from '@flowforge/schemastery'
import { CompactionEngine, ManualCompactionError } from '@flowforge/compaction'
import type { CompactionResult, CompactionTrigger } from '@flowforge/compaction'
import type { TokenMeter } from '@flowforge/token-meter'
import type { Session } from '@flowforge/session'
import { CONTEXT_WINDOW_EXCEEDED_CODE, assertNever } from '@flowforge/llm'
...
import type {} from '@flowforge/compaction-tool-result-pruner'
import {
  resolveCompactSpec,
  resolveConfig,
  resolveTargetPolicy,
