 ...
 *
 * The seam itself lives in `@flowforge/compaction`, which re-exports these
 ...
 * `flowforge-commands/brand` shape.
 *
 * @module @flowforge/compaction/checkpoint
 */

import type { MessageSource } from '@flowforge/llm/message'
