/** Package-owned compaction log-stream invariants. @module @flowforge/compaction/invariant */

import type { Context } from '@flowforge/cordis'
import { isReplacementSurfaceEvent } from '@flowforge/session'
...
const PACKAGE_NAME = '@flowforge/compaction'
