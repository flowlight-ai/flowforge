 ...
 *
 * @module @flowforge/compaction-tool-result-pruner
 */

import { Context, Service } from '@flowforge/cordis'
import z from '@flowforge/schemastery'
import { freezeMessage } from '@flowforge/llm'
import type { ContentBlock } from '@flowforge/llm'
import type { Session, SessionEvent, ToolResultMessage } from '@flowforge/session'
// Type-only: the `compaction/*` SessionEventMap merges (the shadow-price event).
import type {} from '@flowforge/compaction'
