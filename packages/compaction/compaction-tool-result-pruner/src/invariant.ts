/**
 * Package-owned invariant companion for `@flowforge/compaction-tool-result-pruner`.
 * @module @flowforge/compaction-tool-result-pruner/invariant
 */
...
const PACKAGE_NAME = '@flowforge/compaction-tool-result-pruner'
