# @flowforge/compaction-tool-result-pruner
...
This is a concrete companion to [`flowforge-compaction-basic`](../compaction-basic/README.md), not a compaction backend or model-facing tool. Compact-basic reads it through optional `ctx.get('toolResultPruner')`, so either package remains independently composable.
