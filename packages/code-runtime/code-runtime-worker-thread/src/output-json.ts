/** JSON string-prefix accounting for the outer-output ledger. @module @flowforge/code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@flowforge/code-runtime'
