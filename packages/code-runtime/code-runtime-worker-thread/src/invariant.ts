/**
 * Package-owned invariant companion for `@flowforge/code-runtime-worker-thread`.
 * @module @flowforge/code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@flowforge/code-runtime-worker-thread'
