 ...
 *
 * Fidelity to the backend contract (`flowforge-storage` `src/backend.ts`): version
...
import { StorageError } from '@flowforge/storage'
import type { KvFacet, KvUnit, KvUnitDescriptor, StorageBackend } from '@flowforge/storage'
