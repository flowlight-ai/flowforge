/**
 * Package-owned invariant companion for `@flowforge/storage-domain`: every
 ...
 * @module @flowforge/storage-domain/invariant
 */
...
const PACKAGE_NAME = '@flowforge/storage-domain'
