/**
 * Entrusted-work time signal detection (ported from clowder
 * `growing/EntrustedWorkSourceSignals.ts`), used by IntentParser to decide whether
 * a delegation message carries a time-bound custody signal.
 */
