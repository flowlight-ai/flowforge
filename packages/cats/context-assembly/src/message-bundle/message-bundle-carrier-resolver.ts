/**
 * Message Bundle carrier resolver (self-contained port of clowder
 * `MessageBundleCarrierResolver.ts`).
 */
...
import type { BubbleGroupResolver, SourceRecordResolver } from './message-bundle-source-group.ts';
import {
...
import { projectedItem, tombstone } from './message-selection-results.ts';
import type {
