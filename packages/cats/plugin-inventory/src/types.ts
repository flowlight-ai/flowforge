/**
 * @flowforge/cats-plugin-inventory — C30 plugin inventory 类型（P15）
 *
 * TS 移植：clowder-ai `domains/plugin/host-inventory/types.ts`。
 * 14 个 PluginInventoryErrorCode + PluginInventoryError 异常类。
 */
