/**
 * @flowforge/cats-plugin-inventory — C30 manifest-verifier（P15 入场校验）
 *
 * TS 移植：clowder-ai `domains/plugin/host-inventory/manifest-verifier.ts`。
 * 6 项校验：INVALID_MANIFEST / INVALID_PACKAGE_DIGEST /
 * PACKAGE_DIGEST_MISMATCH / PACKAGE_ID_MISMATCH /
 * CONTRACT_VERSION_MISMATCH / INVALID_GRANT。
 */

import { type Capability, validateEffectiveGrants, validateManifest } from './contract.js';
