/**
 * @flowforge/cats-guides — VerifiedConciergeToolTarget（F229 verified tool-result action provenance）。
 *
 ...
 *
 * @module @flowforge/cats-guides/concierge/verified-tool-target
 */

import type { HandleAnchor } from '../models.js';
