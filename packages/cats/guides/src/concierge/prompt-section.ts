/**
 * @flowforge/cats-guides — ConciergePromptSection（F229 PR-A1）。
 *
 * 岗位 prompt 注入 — 构建前台岗位值班专区的 prompt lines。
 * 参照 guides prompt-section.ts 的 compose 模式：返回 string[] 给 SystemPromptBuilder push。
 *
 * 岗位设计来源：
 * - docs/plans/2026-06-10-f229-phase-a-concierge.md §"岗位 prompt section 契约"
 * - docs/features/F229-cat-ball-concierge.md KD-7 / KD-10
 *
 * @module @flowforge/cats-guides/concierge/prompt-section
 */
