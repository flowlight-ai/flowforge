/**
 * @flowforge/cats-packs — C30 PackCompiler（F129 Schema → 规范提示块）
 *
 * TS 移植：clowder-ai `domains/packs/PackCompiler.ts`。
 * 将已校验 pack 内容编译为 SystemPromptBuilder 可消费的提示块。
 *
...
import type { CompiledPackBlocks, PackOnDisk } from '@flowforge/cats-shared';
import {
  PackDefaultsSchema,
