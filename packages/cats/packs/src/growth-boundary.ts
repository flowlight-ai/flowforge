/**
 * @flowforge/cats-packs — C30 GrowthBoundary（KD-11：Pack 不含私有 Growth 数据）
 *
 * TS 移植：clowder-ai `domains/packs/GrowthBoundary.ts`。
 * Pack = 可共享的文化种子；Growth = 本地私密关系果实。
 * 导出的/安装的 pack 中绝不允许出现 Growth 数据。
 */
