/**
 * ASR 人物记忆动态场景构建：把已确认的会议转写投影为写机会（write-opportunity）场景。
 * 忠实移植 clowder-ai `domains/signal-intake/AsrPersonMemorySceneBuilder.ts`。
 * 场景类型/常量见 `contract/asr-person-memory-scene.ts`。
 *
