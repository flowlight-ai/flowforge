/**
 * @flowforge/cats-human-disposition — 词汇候选提取（确定性，非语义分类）。
 *
 * TS 移植自 clowder-ai `domains/memory/proactive-memory-lexical-noise.ts`：
 * CJK 2-6 字滑动窗口 + Latin 段整体候选 + 停用词/语气词噪声过滤。
 *
 * @module @flowforge/cats-human-disposition/lexical-noise
 */
...
const CJK_STOPWORDS: ReadonlySet<string> = new Set([
  '我们', '他们', '你们', '她们', '它们', '大家', '自己',
  '这个', '那个', '这些', '那些', '这样', '那样', '这里', '那里',
  '然后', '因为', '所以', '但是', '虽然', '而且', '或者', '以及', '不过', '因此', '另外', '同时', '于是',
  '已经', '可能', '应该', '非常', '比较', '一定', '一直', '总是', '经常', '马上', '立刻', '终于', '其实', '果然', '居然', '依然', '仍然',
  '可以', '需要', '知道', '觉得', '认为', '希望', '喜欢', '开始', '继续', '使用',
  '什么', '怎么', '如果', '关于', '没有', '不是', '就是', '现在', '时候', '问题', '情况', '方面',
  '一些', '一个', '一下', '一点', '好的', '对的',
  '嗯嗯', '哈哈', '呵呵', '哈哈哈', '笑死', '笑了', '笑哭', '绝了', '服了', '无语', '天哪', '我靠', '卧槽', '离谱', '真的', '太好了',
]);
