 ...
 * `ctx.lsp` → `flowforge-lsp-stdio` stack over the base protocol, exercising all four operations. No API
...
import Lsp, { type LspQueryRequest, type LspQueryResult } from '@flowforge/lsp'
