/**
 * Package-owned invariant companion for `@flowforge/typert-generator`.
 * @module @flowforge/typert-generator/invariant
 */
...
const PACKAGE_NAME = '@flowforge/typert-generator'
