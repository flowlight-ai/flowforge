/**
 * Package-owned invariant companion for `@flowforge/workflow-worker-thread`.
 * @module @flowforge/workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@flowforge/workflow-worker-thread'
