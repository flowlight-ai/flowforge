 ...
 * @module @flowforge/workflow-worker-thread/meta
 */

import { WorkflowError } from '@flowforge/workflow'
import type { WorkflowMeta, WorkflowPhase } from '@flowforge/workflow'
