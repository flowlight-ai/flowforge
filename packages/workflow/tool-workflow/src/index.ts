 ...
 * (`@flowforge/workflow`), so a hardened engine swaps in without touching what the model
 ...
 * @module @flowforge/tool-workflow
 */

import type { Context } from '@flowforge/cordis'
import z from '@flowforge/schemastery'
import { defineTool } from '@flowforge/tools'
import type { ToolCallView, ToolResultView } from '@flowforge/tools'
import type { ContentBlock } from '@flowforge/llm'
import type { JsonValue, Session, SessionEventMap } from '@flowforge/session'
import type {
