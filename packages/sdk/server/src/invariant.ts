/**
 * Package-owned invariant companion for `@flowforge/sdk-jsonrpc-server`.
 * @module @flowforge/sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@flowforge/sdk-jsonrpc-server'
