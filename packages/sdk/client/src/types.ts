 ...
 *
 * @module @flowforge/sdk-client/types
 */
...
export interface HarnessClientOptions {
  /** The runtime executable (the `flowforge-jsonrpc-agent` bin, a packaged exe, or `node`). */
  command: string
   ...
   * credential policy (see `scrubbedParentEnv` in `@flowforge/subprocess`
...
/** Options for the high-level {@link FlowForgeHarness} wrapper. */
export interface FlowForgeHarnessOptions {
