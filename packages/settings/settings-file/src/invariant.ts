/**
 * Package-owned invariant companion for `@flowforge/settings-file`.
 * @module @flowforge/settings-file/invariant
 */
...
const PACKAGE_NAME = '@flowforge/settings-file'
 ...
 * tests; the in-process commit relation is owned by `@flowforge/settings`.
 */
