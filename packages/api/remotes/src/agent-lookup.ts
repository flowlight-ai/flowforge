...
import type { Agent, AgentOptions, AgentSetup } from '@flowforge/agent'
...
import type {} from '@flowforge/typert-registry'
...
export async function inspectApiRemoteSession(
  ...
  if (persistence === undefined) {
    throw new Error('session persistence is not configured (load a flowforge-session-persistence backend)')
  }
