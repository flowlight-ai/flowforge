 ...
 * (`@flowforge/sandbox-local`) and the in-process filesystem fence
 * (`@flowforge/fs-sandbox`) both derive their allow-list here, so "the
 ...
 *
 * @module flowforge-sandbox/roots
 */
