 ...
 *
 * @module @flowforge/sandbox-local/profiles
 */

import { grantArgs as landlockGrantArgs } from '@flowforge/node-addon-landlock-run'
 ...
 * (`@flowforge/fs-sandbox`) can never drift apart.
