 ...
 * is the mandated lock infrastructure under <GetTempPathW()>\flowforge-acl-locks,
...
const SID_STRUCT = koffi.struct('FF_ACL_SPEC_SID', {
  revision: 'uint8',
...
describe.skipIf(!isWin32)('ACL editing', () => {
  ...
  function scratch(): string {
    const dir = mkdtempSync(join(tmpdir(), 'flowforge-acl-edit-'))
