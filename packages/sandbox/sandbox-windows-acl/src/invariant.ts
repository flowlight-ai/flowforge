/**
 * Package-owned invariant companion for `@flowforge/sandbox-windows-acl`.
 * @module @flowforge/sandbox-windows-acl/invariant
 */
...
const PACKAGE_NAME = '@flowforge/sandbox-windows-acl'
