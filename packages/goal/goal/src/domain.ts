 ...
 * these declarations pull flowforge-agent, flowforge-llm, and cordis into the program —
 * the one-program-per-side layout forbids that on client aggregates.
 * @module @flowforge/goal
 */
...
declare module '@flowforge/cordis' {
  interface Events {
     ...
     * @mode emit
     */
    'goal/changed'(this: import('@flowforge/scope').Scoped<Agent>, payload: { agent: Agent; change: GoalChanged }): void
  }
}
