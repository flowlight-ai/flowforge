...
import { createUserMessage, HarnessError } from '@flowforge/llm'
import SessionStore, { Session, SessionId, type UserMessage } from '@flowforge/session'
import GoalService, {
  GoalError,
  GoalId,
  decodeGoalChange,
...
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@flowforge/goal'
...
function stubAgent(rawId: string, seed?: readonly import('@flowforge/session').SessionEvent[]): StubAgent {
