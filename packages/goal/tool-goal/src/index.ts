 ...
 * @module @flowforge/tool-goal
 */

import type { Context } from '@flowforge/cordis'
import z from '@flowforge/schemastery'
import { GoalId } from '@flowforge/goal'
import type { GoalRef, GoalView } from '@flowforge/goal'
import { boundContextSummary, createUserMessage, HarnessError } from '@flowforge/llm'
import { defineTool } from '@flowforge/tools'
import type { GenericCallView } from '@flowforge/tools'
