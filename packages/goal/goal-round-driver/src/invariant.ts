/** Package-owned goal-round prompt invariants. @module @flowforge/goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@flowforge/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@flowforge/goal'
import type { InvariantFailure, InvariantInstaller } from '@flowforge/invariants'
import type { Session, SessionEvent } from '@flowforge/session'
import { renderGoalRoundPrompt } from './prompt.ts'

const PACKAGE_NAME = '@flowforge/goal-round-driver'
