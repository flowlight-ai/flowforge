 ...
 * Concrete
 * providers such as `@flowforge/skill-filesystem` decide where skills come
 ...
 *
 * @module @flowforge/skill
 */

import { Context, Service } from '@flowforge/cordis'
import { assertNever } from '@flowforge/llm'
import { NamedEntries, ScopedLayers, scopeChainOf, scopeOf } from '@flowforge/scope'
import type { ScopeKey, ScopeLayer } from '@flowforge/scope'
...
export type SkillSource = 'project-flowforge' | 'project-agents' | 'runtime' | 'user-flowforge' | 'user-agents' | 'custom' | 'bundled' | (string & {})
