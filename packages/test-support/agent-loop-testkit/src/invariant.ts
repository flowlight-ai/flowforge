/**
 * Package-owned invariant companion for `@flowforge/agent-loop-testkit`.
 * @module @flowforge/agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@flowforge/agent-loop-testkit'
