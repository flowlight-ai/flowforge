...
import { hostFrameSchema, muxFrameSchema } from '@flowforge/host-apiproxy/api/events.schema'
import { serverRequestSchema } from '@flowforge/host-apiproxy/api/rpc.schema'
