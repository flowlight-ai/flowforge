/**
 * Package-owned invariant companion for `@flowforge/client-connection`.
 * @module @flowforge/client-connection/invariant
 */
...
const PACKAGE_NAME = '@flowforge/client-connection'
