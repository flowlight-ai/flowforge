...
import type {} from '@flowforge/attachment'
// Activates the webServer Context merge used below.
import type { WebRoute, WebUpgradeRoute } from '@flowforge/host-webserver'
import { toFetchHandler } from '@flowforge/host-apiproxy'
...
export interface ConnectionConfig {
   ...
   * by (the flowforge CLI derives the machine's LAN IP literals itself). An entry
