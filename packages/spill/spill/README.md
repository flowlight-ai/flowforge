...
| Package | Role |
|---|---|
| `@flowforge/spill` (this) | Service Definition: abstract service + vocabulary types |
| `@flowforge/spill-local` | Service Provider: private session-scoped files on the host filesystem |
| `@flowforge/spill-policy` | Consumer: the tool-result policy that spills oversized final results |
