...
import { foldSurface, isSurfaceEvent, snapshotSessionEvent } from '@flowforge/session'
import type { SessionEvent, SessionId, SurfaceEvent, SurfaceEventType } from '@flowforge/session'
