 ...
 *
 * @module @flowforge/session-query
 */

import { Context, Service } from '@flowforge/cordis'
import { Session, snapshotSessionEvent, type SessionId } from '@flowforge/session'
import { foldSessionTitle } from '@flowforge/session-title'
import type { SessionTitleSnapshot } from '@flowforge/session-title'
import type {
