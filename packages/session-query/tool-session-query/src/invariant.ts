/**
 * Package-owned invariant companion for `@flowforge/tool-session-query`.
 * @module @flowforge/tool-session-query/invariant
 */
...
const PACKAGE_NAME = '@flowforge/tool-session-query'
