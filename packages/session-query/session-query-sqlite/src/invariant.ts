/**
 * Package-owned invariant companion for `@flowforge/session-query-sqlite`.
 * @module @flowforge/session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@flowforge/session-query-sqlite'
