/** Package-owned invariant companion for `@flowforge/attachment-local`. @module @flowforge/attachment-local/invariant */

/* jscpd:ignore-start */
import type { Context } from '@flowforge/cordis'
import type { InvariantInstaller } from '@flowforge/invariants'

const PACKAGE_NAME = '@flowforge/attachment-local'
