...
import type { EntryInfo, Sandbox } from '@flowforge/e2b'

const VERSION_METADATA_KEY = 'flowforge-version'
...
export class E2BFileSystem extends FileSystem {
  ...
  private async writeAtomic(
    ...
    const stagingDirectory = posix.join(posix.dirname(targetPath), `.flowforge-${randomUUID()}.tmp`)
