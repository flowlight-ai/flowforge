...
/** Lossless JSON value accepted by a provider request body. */
...
/**
 * Merge-extensible table of top-level request extension fields.
...
export interface DeepSeekLlmApiExtensionRequest {
  /** Base request body before extension fields are merged. */
