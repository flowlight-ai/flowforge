 ...
 *
 * @module flowforge-llm-deepseek/adapter
 */

import { attributionHeaders, CONTEXT_WINDOW_EXCEEDED_CODE, isContextWindowExceededError, isQuotaExceededError, LlmAdapter, LlmError, ProviderRequestId, QUOTA_EXCEEDED_CODE, ReasoningEffortId } from '@flowforge/llm'
import type {
  GenerateOptions,
  LlmModelInfo,
  LlmProviderInfo,
...
import { idleWatchdog, timeoutOf } from '@flowforge/timeout'
import type { AnonymousUserId } from '@flowforge/anonymous-user-id'
...
export class DeepSeekAdapter extends LlmAdapter {
  ...
  private async * request(
    ...
    const headers = {
      ...
      ...attributionHeaders(),
      'x-flowforge-user-id': String(userId),
      ...options.sessionId !== undefined
        ? { 'x-flowforge-session-id': String(options.sessionId) }
        : {},
      ...options.purpose === 'compaction'
        ? { 'x-flowforge-compact': '1' }
        : {},
    }
