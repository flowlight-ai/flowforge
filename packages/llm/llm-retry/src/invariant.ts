/** Package-owned durable retry-event invariants. @module @flowforge/llm-retry/invariant */

import type { Context } from '@flowforge/cordis'
import type { Session, SessionEvent } from '@flowforge/session'
import type { LlmFailure } from '@flowforge/llm'
...
const PACKAGE_NAME = '@flowforge/llm-retry'
