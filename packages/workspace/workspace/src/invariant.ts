/**
 * Package-owned invariant companion for `@flowforge/workspace`.
 * @module @flowforge/workspace/invariant
 */
...
import { WorkspaceId } from '@flowforge/workspace'

const PACKAGE_NAME = '@flowforge/workspace'
