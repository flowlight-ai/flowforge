/**
 * Package-owned invariant companion for `@flowforge/host-frontend-static`.
 * @module @flowforge/host-frontend-static/invariant
 */

import type { Context } from '@flowforge/cordis'
import type { InvariantInstaller } from '@flowforge/invariants'

const PACKAGE_NAME = '@flowforge/host-frontend-static'
