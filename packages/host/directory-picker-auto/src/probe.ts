 ...
 * sampled fact for the resolver, so an attended Linux host without zenity or
 * kdialog keeps the working `browse` interaction instead of a backend whose
 * every pick fails.
 * @module @flowforge/directory-picker-auto/probe
 */
