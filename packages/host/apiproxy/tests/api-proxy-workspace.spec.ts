...
import type { Agent, AgentFactory } from '@flowforge/agent'
import SessionStore, { SessionId } from '@flowforge/session'
import type { Session } from '@flowforge/session'
import Storage from '@flowforge/storage'
import { DomainFacility } from '@flowforge/storage-domain'
import UserQuestionService from '@flowforge/user-questions'
import { DirectoryPickerError } from '@flowforge/host-directory-picker'
import type { DirectoryPickerCapability } from '@flowforge/host-directory-picker'
import WorkspaceRegistry from '@flowforge/workspace'
import type { HostFrame, WorkspaceId } from '@flowforge/host-apiproxy/api'
import type { RpcRequest, RpcResponse } from '@flowforge/host-apiproxy/api/rpc'
import { RpcId } from '@flowforge/host-apiproxy/api/rpc'
import { createApiProxy } from '@flowforge/host-apiproxy'
...
async function harness(
  root = realpathSync.native(mkdtempSync(join(tmpdir(), 'apiproxy-workspace-'))),
