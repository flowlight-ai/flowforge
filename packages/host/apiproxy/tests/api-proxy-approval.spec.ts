...
import type { ApprovalRequestId } from '@flowforge/user-approval'
import type { ApiProxy, MuxFrame, RpcRequest } from '@flowforge/host-apiproxy/api'
import type { RpcId } from '@flowforge/host-apiproxy/api/rpc'
import { RpcId as mintRpcId } from '@flowforge/host-apiproxy/api/rpc'
