...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef } from '@flowforge/attachment'
 ...
 * the tools vocabulary into this schema and drift with it.
 */
