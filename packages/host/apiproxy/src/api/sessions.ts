...
import type { AttachmentIdType, ImageAttachmentLimits, ImageAttachmentRef, ImageMediaType } from '@flowforge/attachment'
import type { ContentBlock } from '@flowforge/llm/types'
import type { SessionEvent, SessionId } from '@flowforge/session/types'
// The pure-type outlet: api/ is browser-importable, and the package root's
// cordis Context merge (via agent) must not enter client aggregates.
import type { SessionProjectionMap } from '@flowforge/session-projection/types'
