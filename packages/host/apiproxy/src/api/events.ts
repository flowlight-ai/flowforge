...
import type { AskUserQuestionItem } from '@flowforge/user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from '@flowforge/user-approval/types'
import type { Message } from '@flowforge/llm/types'
import type { MessageId } from '@flowforge/llm/brand'
import type { CallId } from '@flowforge/llm/brand'
import type { JsonValue, SessionEvent, SessionId } from '@flowforge/session/types'
import type { ToolCallView, ToolResultView } from '@flowforge/tools/presentation'
import type { RpcError, RpcId, RpcRequest } from './rpc.ts'
import type { JobView } from './jobs.ts'
import type { WorkspaceView } from './workspace.ts'

// Client-side consumers take the render-intent vocabulary from the contract;
// tools remains its owner.
...
export type HostFrame =
   ...
   * owned by `@flowforge/api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
