/** Package-owned invariant companion for the directory-picker seam. @module @flowforge/host-directory-picker/invariant */

import type { Context } from '@flowforge/cordis'
import type { InvariantInstaller } from '@flowforge/invariants'

const PACKAGE_NAME = '@flowforge/host-directory-picker'
