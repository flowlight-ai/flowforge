/**
 * Package-owned invariant companion for `@flowforge/tool-call-timeout-policy`.
 * @module @flowforge/tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@flowforge/tool-call-timeout-policy'
