/**
 * Unit + real-load-path coverage for @flowforge/tool-call-timeout-policy. The
...
import { CallId, HarnessError } from '@flowforge/llm'
import SystemPrompt from '@flowforge/system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@flowforge/tools'
import * as timeoutPolicy from '@flowforge/tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@flowforge/tool-call-timeout-policy'
...
describe('flowforge-tool-call-timeout-policy real-load-path guard', () => {
