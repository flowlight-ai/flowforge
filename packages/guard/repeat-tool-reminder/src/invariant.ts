/**
 * Package-owned invariant companion for `@flowforge/repeat-tool-reminder`.
 * @module @flowforge/repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@flowforge/repeat-tool-reminder'
