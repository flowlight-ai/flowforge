import { EntryGroup, EntryTree, isJsExpr, type EntryOptions } from '@flowforge/cordis-plugin-loader'
 ...
 * (`flowforge --dump-config`) parses and prints exactly the dialect this include
 * mounts.
 */
 ...
 * (`flowforge --dump-config`) so a dump can never drift from what boots. The input
